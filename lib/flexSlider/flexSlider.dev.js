    ...
    $.fn.flexSlider = function (options) {
        ...
        return this.each(function () {
           ...
           */        
            ...
            /* Add the ability to link to a specific item in the slider externally. EG, from a carousel of thumbs elsewhere on the page */
            //find links to sliderItems #[sliderID:[index]]
            (function(){
                console.log(parent.attr("id"));
                var $externalLinks = $("a[href^='#"+parent.attr("id")+"']");
                $("body").on("click","a[href^='#"+parent.attr("id")+"']",function(e){
                    e.preventDefault();
